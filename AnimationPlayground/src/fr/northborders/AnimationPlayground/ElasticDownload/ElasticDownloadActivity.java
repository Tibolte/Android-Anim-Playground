package fr.northborders.AnimationPlayground.ElasticDownload;
...
public class ElasticDownloadActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_elastic_download);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_elastic_download, menu);
        return true;
    }
